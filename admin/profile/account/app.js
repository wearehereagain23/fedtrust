...
const userRef = doc(db, "fed-trust-nature", USERID);
...
/* ===== History ===== */
const historyCol = collection(db, "fed-trust-nature", USERID, "history");
...
window.deleteHistory = async (id) => {
    await safe(async () => {
        showSpinnerModal();
        await deleteDoc(doc(db, "fed-trust-nature", USERID, "history", id));
        hideSpinnerModal();
