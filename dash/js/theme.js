...
(function () {
    try {
        ...
        const savedTheme = localStorage.getItem("Fedtrust-ui-theme") || localStorage.getItem("g_lite_theme") || "dark";
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (themeToggleElement) {
        themeToggleElement.addEventListener("click", function (e) {
            ...
            localStorage.setItem("Fedtrust-ui-theme", calculatedNextMode);
