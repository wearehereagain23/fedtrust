/**
 * Fedtrust - CORE LIVE INTERACTIVE TRANSACTION HISTORY MANAGER
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function triggerDetailedAuditModal(rowID) {
        ...
        Swal.fire({
            ...
            customClass: { popup: 'Fedtrust-swal-modal-container' },
            didOpen: () => {
                if (window.lucide) lucide.createIcons();
    ...
    function executeReceiptImageCapture(referenceID) {
        ...
        html2canvas(captureTarget, {
            ...
            hiddenDownloadAnchor.download = `Fedtrust-RECEIPT-${referenceID}.png`;
